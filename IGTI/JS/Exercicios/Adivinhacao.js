...
var rl = readline.createInterface({ //pede como parametro um obj json
...
pergunta()
function pergunta() { //funcao necessaria fazer continuar o programa depois que o usuario digita o numero pois devem ser 10 tentativas consecutivas.
rl.question("Adivinhe o número: ", function(numero) { //funcao que trabalha com numeros, é um callback pois o usuario pode demorar muito tempo para digitar o numero enquanto isso o node vai fazendo outras coisas, qdo num for digitado ele retorna pela funcao
    numero = parseInt(numero)
    numTentativas-- //decrementa o numero de tentativas a cada laço
        if (numero === numAleatorio) { //passo 6
            console.log("Parabéns! Você acertou o número")
            rl.close() //encerra o jogo 
        } else if (numTentativas === 0) { //passo 8
            console.log("Que pena, você não adivinhou o número em dez tentativas.")
            rl.close()
        } else if (numero > numAleatorio) {
            console.log ("Número errado, você ainda possui " + numTentativas + " tentativas. " +
